...
{"constant":true,"inputs":[],"name":"getBudget","outputs":[{"name":"_getGoalDemurrage","type":"uint256"}
,{"name":"_getGoalCrowdFunding","type":"uint256"},{"name":"_getGoalCommunityHours","type":"uint256"}
,{"name":"_getGoalExpenses","type":"uint256"},{"name":"_getcommitCrowdFunding","type":"uint256"}
,{"name":"_getCommitCommunityHours","type":"int256"}
,{"name":"_getCommitExpenses","type":"uint256"}
,{"name":"_getRealDemurrage","type":"uint256"}
,{"name":"_getRealCrowdFunding","type":"uint256"}
,{"name":"_getRealCommunityHours","type":"uint256"}
,{"name":"_getRealExpenses","type":"uint256"}],"type":"function"}
...
,{"constant":false,"inputs":[{"name":"_NewGoalDemurrage","type":"uint256"},{"name":"_newGoalCrowdFunding","type":"uint256"}
,{"name":"_newGoalCommunityHours","type":"uint256"}
,{"name":"_newGoalExpenses","type":"uint256"}],"name":"setNewBudget","outputs":[],"type":"function"}
,{"constant":false,"inputs":[],"name":"creditUpdate","outputs":[],"type":"function"}
,{"constant":false,"inputs":[{"name":"_commitF","type":"uint256"}],"name":"commitFunding","outputs":[],"type":"function"}
,{"constant":false,"inputs":[{"name":"_newMember","type":"address"},{"name":"_newAlias","type":"string"}],"name":"acceptMember","outputs":[],"type":"function"}
...
,{"name":"_getIniMemberCCUs","type":"int256"},{"name":"_getIniMemberReputation","type":"uint256"}
...
,{"constant":true,"inputs":[],"name":"getMoneyTotals","outputs":[{"name":"_getTotalMinted","type":"int256"}
,{"name":"_getTotalCredit","type":"uint256"}
,{"name":"_getTotalTrustCost","type":"uint256"}
,{"name":"_getTotalTrustAvailable","type":"uint256"}],"type":"function"}
...
,{"constant":false,"inputs":[{"name":"_payH","type":"int256"}],"name":"payHours","outputs":[],"type":"function"}
...
,{"constant":false,"inputs":[{"name":"_commitH","type":"int256"}],"name":"commitHours","outputs":[],"type":"function"}
,{"constant":false,"inputs":[{"name":"_payF","type":"uint256"}],"name":"payFunding","outputs":[],"type":"function"}
...
,{"anonymous":false,"inputs":[{"indexed":false,"name":"_nMember","type":"address"}
,{"indexed":false,"name":"_nAlias","type":"string"}
,{"indexed":false,"name":"_timeStampNM","type":"uint256"}],"name":"newMember","type":"event"}
,{"anonymous":false,"inputs":[{"indexed":false,"name":"_exMember","type":"address"}
,{"indexed":false,"name":"_exAlias","type":"string"}
,{"indexed":false,"name":"_timeStampExM","type":"uint256"}],"name":"exMember","type":"event"}
]);
